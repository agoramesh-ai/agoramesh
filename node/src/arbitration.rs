//! Arbitration Integration for AgoraMesh.
//!
...
//!
//! ```rust,ignore
//! use agoramesh_node::arbitration::{AIArbitrator, AIArbitrationConfig, Evidence};
//!
...
//!
//! ```rust,ignore
//! use agoramesh_node::arbitration::{KlerosClient, KlerosConfig, DisputeStatus};
//!
...
/// Ruling options for AgoraMesh disputes.
...
pub struct KlerosConfig {
    ...
    /// Court/subcourt ID for AgoraMesh disputes.
    pub court_id: u64,
...
impl KlerosClient {
    ...
    ///
    /// # Arguments
    /// * `choices` - Number of possible rulings (typically 3 for AgoraMesh)
    ///
    /// # Returns
    ...
    /// For AgoraMesh, we require a minimum USDC stake equivalent.
    ///
    /// # Arguments
...
mod tests {
    ...
    fn test_evidence_new() {
        ...
        assert_eq!(evidence.submitter_did, "did:agoramesh:base:client123");
    ...
    #[test]
    fn test_juror_new() {
        let juror = Juror::new("did:agoramesh:base:juror1", 500_000_000, vec![0, 1]);

        assert_eq!(juror.did, "did:agoramesh:base:juror1");
