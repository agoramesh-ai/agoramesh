//! Common test utilities for AgoraMesh Node integration tests.
//!
...
pub fn create_test_state() -> AppState {
    AppState {
        ...
        trust: Arc::new(agoramesh_node::TrustService::new(
...
pub fn test_did(suffix: &str) -> String {
    format!("did:agoramesh:base:test-{}", suffix)
}

/// Generate a test capability card JSON.
/// Note: `did` is used in the x-agoramesh extension, `name` is the agent name.
