...
import { CrossChainTrustClient } from './crosschain.js';
// =============================================================================
// Test Setup
// =============================================================================
// Mock contract addresses (would be real deployed addresses in integration tests)
const CROSS_CHAIN_SYNC_ADDRESS = '0x1234567890123456789012345678901234567890';
const CHAIN_REGISTRY_ADDRESS = '0x2345678901234567890123456789012345678901';
...
describe('CrossChainTrustClient', () => {
    ...
    beforeEach(() => {
        ...
        client = new CrossChainTrustClient(mockPublicClient, mockWalletClient, config);
    });
    // ============ Constructor Tests ============
...
//# sourceMappingURL=crosschain.test.js.map