...
async function main() {
  ...
  const providerDid = 'did:agoramesh:base-sepolia:test-agent-001';
  const clientDid = 'did:agoramesh:base-sepolia:test-client-001';
  ...
  console.log('╔══════════════════════════════════════════════════════════╗');
  console.log('║           AGORAMESH ESCROW PAYMENT FLOW                   ║');
  console.log('╚══════════════════════════════════════════════════════════╝\n');
