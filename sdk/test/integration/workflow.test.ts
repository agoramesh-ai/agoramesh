...
describe('Complete Agent Discovery and Payment Workflow', () => {
  let clientAgent: AgoraMeshClient;
  let providerAgent: AgoraMeshClient;
  ...
  beforeEach(() => {
    ...
    clientAgent = new AgoraMeshClient({
      rpcUrl: TEST_RPC_URL,
    ...
    providerAgent = new AgoraMeshClient({
      rpcUrl: TEST_RPC_URL,
      chainId: TEST_CHAIN_ID,
...
describe('Multi-Agent Collaboration Workflow', () => {
  ...
  it('should orchestrate task between multiple agents', async () => {
    ...
    const agents = {
      orchestrator: {
        did: 'did:agoramesh:base:0x1111111111111111111111111111111111111111',
        address: '0x1111111111111111111111111111111111111111' as const,
      },
      translator: {
        did: 'did:agoramesh:base:0x2222222222222222222222222222222222222222',
        address: '0x2222222222222222222222222222222222222222' as const,
      },
      reviewer: {
        did: 'did:agoramesh:base:0x3333333333333333333333333333333333333333',
    ...
    const orchestratorClient = new AgoraMeshClient({
      rpcUrl: TEST_RPC_URL,
      chainId: TEST_CHAIN_ID,
...
describe('Error Handling and Edge Cases', () => {
  ...
  it('should handle unregistered agent gracefully', async () => {
    ...
    const score = await trust.getTrustScore('did:agoramesh:base:0x0000000000000000000000000000000000000000');
